...
void testBasicNodeOperations() {
    ...
    auto g = Graph<int>::create("TestGraph", false);
...
void testBasicEdgeOperations() {
    ...
    auto g = Graph<std::string>::create("EdgeTest", false);
...
void testDirectedGraph() {
    ...
    auto g = Graph<int>::create("DirectedGraph", true);
...
void testUndirectedGraph() {
    ...
    auto g = Graph<int>::create("UndirectedGraph", false);
    ...
    assert(n1->getTotalDegree() == 2);
    assert(n2->getTotalDegree() == 2);
...
void testHierarchicalStructure() {
    ...
    auto root = Graph<int>::create("Root", false);
    ...
    auto sub1 = root->createSubGraph("SubGraph1");
    auto sub2 = root->createSubGraph("SubGraph2");
    
    assert(root->getSubGraphCount() == 2);
    assert(root->isLeaf() == false);
    assert(sub1->isRoot() == false);
    assert(sub1->getDepth() == 1);
    assert(sub1->getParentGraph().get() == root.get());
    
    auto sub1_1 = sub1->createSubGraph("SubGraph1_1");
    
    assert(sub1_1->getDepth() == 2);
    assert(sub1_1->getRootGraph().get() == root.get());
    assert(root->getRootGraph().get() == root.get());
    
    assert(sub1_1->isDescendantOf(root.get()) == true);
    assert(root->isAncestorOf(sub1_1.get()) == true);
    assert(sub1_1->isDescendantOf(sub2.get()) == false);
    
    auto found = root->getSubGraph("SubGraph1");
    assert(found == sub1);
...
void testNodeRemovalCleansEdges() {
    ...
    auto g = Graph<int>::create("CleanupTest", false);
...
void testGetEdgesFromTo() {
    ...
    auto g = Graph<std::string>::create("EdgeQueryTest", true);
...
void testClearOperations() {
    ...
    auto g = Graph<int>::create("ClearTest", false);
...
void testCopyOperations() {
    ...
    auto original = Graph<std::string>::create("Original", true);
    ...
    auto subCopy = copy->getSubGraph("Sub");
    assert(subCopy != nullptr);
    assert(subCopy->getParentGraph().get() == copy.get());
...
void testPrintFunctions() {
    ...
    auto g = Graph<int>::create("PrintTest", false);
    g->addNode(10);
    g->addNode(20);
    g->addEdge(0, 1);
    
    auto sub = g->createSubGraph("SubPrint");
    sub->addNode(100);
...
void testNeighborQueries() {
    ...
    auto g = Graph<int>::create("NeighborTest", false);
...
void testEdgeCases() {
    ...
    auto g = Graph<int>::create("EdgeCaseTest", true);
    ...
    auto other = Graph<int>::create("Other", true);
...
void testBFSAlgorithm() {
    ...
    auto g = Graph<int>::create("BFSTest", false);
    ...
    auto directedG = Graph<int>::create("DirectedBFSTest", true);
...
void testDFSAlgorithm() {
    ...
    auto g = Graph<int>::create("DFSTest", false);
    ...
    auto directedG = Graph<int>::create("DirectedDFSTest", true);
    Node<int>* d0 = directedG->addNode(0);
    Node<int>* d1 = directedG->addNode(1);
    Node<int>* d2 = directedG->addNode(2);
...
void testDFSRecursiveAlgorithm() {
    ...
    auto g = Graph<int>::create("DFSRecursiveTest", false);
    ...
    auto linearG = Graph<int>::create("LinearDFS", true);
...
void testGraphTraversalEdgeCases() {
    ...
    auto emptyG = Graph<int>::create("EmptyGraph", false);
    assert(bfs(*emptyG, 0).empty());
    assert(dfs(*emptyG, 0).empty());
    assert(dfsRecursive(*emptyG, 0).empty());
    
    auto singleNodeG = Graph<int>::create("SingleNode", false);
    ...
    auto disconnectedG = Graph<int>::create("Disconnected", false);
...
void testGraphTraversalOptimized() {
    ...
    auto g = Graph<int>::create("OptimizedTest", false);
    Node<int>* n0 = g->addNode(0);
    Node<int>* n1 = g->addNode(1);
    Node<int>* n2 = g->addNode(2);
    Node<int>* n3 = g->addNode(3);
